...
public class WfrWebDriver {
  ...
  public static void main(String[] args) {
    ...
    // 20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@class='icon-email' and
    // @aria-label='To-Do']")));

    // CLOCK IN

    // new WebDriverWait(driver,
    // 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@class='time-clock-button' and @data-type='PUNCH']")));
    WebElement clockInButton =
        driver.findElement(By.xpath("//button[@class='time-clock-button' and @data-type='PUNCH']"));
    clockInButton.click();

    // new WebDriverWait(driver,
    // 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@role='alertdialog']")));

    WebElement messageClockInPopup =
        driver.findElement(By.xpath("//*[@id='msg--body-react_modal']"));

    // new WebDriverWait(driver,
    // 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//button[text()='ok']")));
    ...
    // new WebDriverWait(driver,
    // 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@data-type='PUNCH_OUT']")));
    ...
    WebElement messageClockOutPopup =
        driver.findElement(By.xpath("//*[@id='msg--body-react_modal']"));
    ...
    // new WebDriverWait(driver,
    // 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@title='Team']")));
    ...
    WebElement formsButton =
        driver.findElement(By.xpath("//button[@aria-label='HR - Forms section']"));
    formsButton.click();

    WebElement otherFormsButton =
        driver.findElement(By.cssSelector("#tab-manager [aria-label='Forms - Other Forms']"));
    otherFormsButton.click();

    // new WebDriverWait(driver,
    // 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[contains(@class,'btn
    // btn-secondary ') and text()='Open']")));
    WebElement openTab =
        driver.findElement(
            By.xpath("//*[contains(@class,'btn btn-secondary ') and text()='Open']"));
    openTab.click();
    ...
    // new WebDriverWait(driver,
    // 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//td/span/button[contains(@class,
    // 'btn-meta notes  unread')]")));
    int numberOfNotes;
    if (driver
        .findElement(By.xpath("//td/span/button[contains(@class, 'btn-meta notes  unread')]"))
        .isDisplayed()) {
      numberOfNotes =
          Integer.parseInt(
              driver
                  .findElement(
                      By.xpath("//td/span/button[contains(@class, 'btn-meta notes  unread')]"))
    ...
    WebElement threeDots =
        driver.findElement(
            By.xpath("(//*[@class='div-table-body']/tr)[1]//i[@class='icon-more-actions']"));
    threeDots.click();
